        ...
        <div class="container">
            ...
            <div>
                <form method="POST" action="Artikal">
                    ...
                    <select name="odaberi" class="btn-dropdown ">
                        <option value="1">Kolaci</option>
                        <option value="2">Palacinke</option>
                        <option value="3">Slatko od</option>
                    </select>
                    <button type="submit" name="izaberi" class="btn btn-info" value="izaberi">Izaberi</button><br>
                    <%}%>
                ...
                <table class="table table-sm table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td><% if (uloga > 0) {%>
                            <form method="post" action="Korpa"> <button class="btn-succes" value="<%= p.getPonudaID()%>" name="dugme">Dodaj u korpu</button></form><br>
                            <%}%>
                            <% if (uloga == 3) {%>
                            <form method="post" action="Artikal"><button class="btn-delete" value="<%= p.getPonudaID()%>" name="brisanjeUpit">Obrisi</button>
                            <%}%>
                            <% if (uloga == 2 || uloga == 3) {%>
                            <button class="btn-change" value="<%= p.getPonudaID()%>" name="promeni">Izmeni</button></form>
                            <%}%></td>
                    </tr>
